...
{
    public class Tick : BaseDataCollection
    {
        private static readonly TickDataPoint _factory = new();
        ...
        public Tick(Tick original)
        {
            ...
            Data = original.Data?.ToList(point => point.Clone());
        }
        ...
        {
            return _factory.Reader(config, reader, date, isLiveMode);
        }
    ...
    public class TickDataPoint : BaseData
    {
        ...
        /// </summary>
        /// <param name="original">Original tick we're cloning</param>
        public TickDataPoint(TickDataPoint original)
        {
            Symbol = original.Symbol;
        ...
        public TickDataPoint(DateTime time, Symbol symbol, decimal bid, decimal ask)
        {
            DataType = MarketDataType.Tick;
            Time = time;
            Symbol = symbol;
        ...
        public TickDataPoint(DateTime time, Symbol symbol, decimal last, decimal bid, decimal ask)
        {
            DataType = MarketDataType.Tick;
            Time = time;
            Symbol = symbol;
        ...
        public TickDataPoint(DateTime time, Symbol symbol, string saleCondition, string exchange, decimal quantity, decimal price)
        {
            Value = price;
            Time = time;
            DataType = MarketDataType.Tick;
        ...
        public TickDataPoint(DateTime time, Symbol symbol, string saleCondition, string exchange, decimal bidSize, decimal bidPrice, decimal askSize, decimal askPrice)
        {
            Time = time;
            DataType = MarketDataType.Tick;
            Symbol = symbol;
        ...
        public TickDataPoint(Symbol symbol, string line)
        {
            var csv = line.Split(',');
            DataType = MarketDataType.Tick;
            Symbol = symbol;
        ...
        public TickDataPoint(Symbol symbol, string line, DateTime baseDate)
        {
            var csv = line.Split(',');
            DataType = MarketDataType.Tick;
            Symbol = symbol;
        ...
        public TickDataPoint(SubscriptionDataConfig config, StreamReader reader, DateTime date)
        {
            try
            {
                DataType = MarketDataType.Tick;
        ...
        /// <param name="date">Base date for the tick (ticks date is stored as int milliseconds since midnight)</param>
        /// <param name="config">Subscription configuration object</param>
        public TickDataPoint(SubscriptionDataConfig config, string line, DateTime date)
        {
            try
            {
                DataType = MarketDataType.Tick;
        ...
        public override BaseData Reader(SubscriptionDataConfig config, string line, DateTime date, bool isLiveMode)
        {
            ...
            return new TickDataPoint(config, line, date);
        }
        ...
        public override BaseData Reader(SubscriptionDataConfig config, StreamReader reader, DateTime date, bool isLiveMode)
        {
            ...
            return new TickDataPoint(config, reader, date);
        }
