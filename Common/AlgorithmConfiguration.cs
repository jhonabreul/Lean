...
namespace QuantConnect
{
    ...
    public class AlgorithmConfiguration
    {
        ...
        /// </summary>
        public AlgorithmConfiguration(string name, IReadOnlyList<string> tags, string accountCurrency, BrokerageName brokerageName,
            AccountType accountType, IReadOnlyDictionary<string, string> parameters, DateTime startDate, DateTime endDate,
            DateTime? outOfSampleMaxEndDate, int outOfSampleDays = 0)
        {
            Name = name;
            Tags = tags;
