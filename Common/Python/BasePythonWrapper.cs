...
namespace QuantConnect.Python
{
    ...
    public class BasePythonWrapper<TInterface>
    {
        ...
        public T InvokeMethod<T>(string methodName, params object[] args)
        {
            ...
            return InvokeMethod<T>(methodName, ref method, args);
        }
        ...
        {
            PyObject method = null;
            return InvokeMethod(methodName, ref method, args);
        }
        ...
        /// <param name="methodName">The name of the method</param>
        /// <param name="method">
        /// The method to use if not null.Else, the method is looked up and assigned to this for the caller to store or use
        /// </param>
        /// <param name="args">The arguments to call the method with</param>
        /// <returns>The returned valued converted to the given type</returns>
        public T InvokeMethod<T>(string methodName, ref PyObject method, params object[] args)
        {
            using var _ = Py.GIL();
            if (method == null)
            {
        ...
        /// </param>
        /// <param name="args">The arguments to call the method with</param>
        protected PyObject InvokeMethod(string methodName, ref PyObject method, params object[] args)
        {
            using var _ = Py.GIL();
            if (method == null)
            {
