...
namespace QuantConnect.Algorithm.CSharp
{
    /// <summary>
    /// </summary>
    public class ContinuousFutureRolloverExchangeTimeZoneBehindDataRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void Initialize()
        {
            ...
            MarketHoursDatabase.SetEntry(Market.CME, ticker, SecurityType.Future, marketHours.ExchangeHours, dataTimeZone);
