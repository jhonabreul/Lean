...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class WarmupLowerResolutionOptionRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.06%"},
            {"Average Loss", "-0.09%"},
            {"Compounding Annual Return", "-2.612%"},
            {"Drawdown", "0.300%"},
            {"Expectancy", "-0.157"},
            {"Start Equity", "100000"},
            {"End Equity", "99971"},
            ...
            {"Annual Variance", "0"},
            {"Information Ratio", "-9.135"},
            {"Tracking Error", "0.016"},
            {"Treynor Ratio", "0.073"},
            {"Total Fees", "$4.00"},
            {"Estimated Strategy Capacity", "$68000.00"},
            {"Lowest Capacity Asset", "AAPL 2ZTXYMUME0LUU|AAPL R735QTJ8XC9X"},
            {"Portfolio Turnover", "2.27%"},
            {"OrderListHash", "d15f791c36c0ee39a1ec97eb475382e4"}
        };
    }
}
